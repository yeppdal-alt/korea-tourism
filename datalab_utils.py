...
#
# ⚠️ 주의: 강원도와 전라북도는 각각 "특별자치도"로 전환되면서 행정안전부가
# 시/도 코드 앞 2자리를 아예 바꿨습니다. (도로명주소 관리시스템 공지 기준)
#   - 강원도 -> 강원특별자치도 (2023-06-11 전환) : 코드 42 -> 51
#   - 전라북도 -> 전북특별자치도 (2024-01-18 전환) : 코드 45 -> 52
# 이 앱은 2025년 데이터(두 전환일 모두 지난 시점)를 조회하므로, 바뀐 새 코드를 씁니다.
# 만약 나중에 2023년 이전 데이터를 다룬다면 이 코드가 맞지 않을 수 있습니다.
STANDARD_SIDO_CODE = {
    "서울": "11",
    "부산": "26",
    "대구": "27",
    ...
    "세종특별자치시": "36",
    "경기도": "41",
    "강원도": "51",  # 강원특별자치도 전환(2023-06-11)으로 42 -> 51 로 변경됨
    "충청북도": "43",
    "충청남도": "44",
    "전라북도": "52",  # 전북특별자치도 전환(2024-01-18)으로 45 -> 52 로 변경됨
    "전라남도": "46",
    "경상북도": "47",
    "경상남도": "48",
    "제주도": "50",
